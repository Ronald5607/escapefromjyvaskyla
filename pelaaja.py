...
class Pelaaja:
    def __init__(self, nimi:str, aloituspaikka:str): #pelaajalle pitää alustaa nimi (esim (input("Nimi: "))ja aloituspaikka
        self.nimi=nimi
        self.sijainti = aloituspaikka #jos haluaa sisältää aseman nimen tähän, voisi sijainnin muuntaa esim. tupleksi jossa on ident ja nimi
        self.viimeisimmat=[]
